...
/*   Updated: 2024/07/17 17:11:52 by izanoni          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	bt_exit(t_minishell *s_minishell, t_fds	fd_redirect)
{
	...
	i = 0;
	if (s_minishell->current_command[1] != NULL && s_minishell->current_command[2] != NULL)
	{
	...
	{
		while (ft_isdigit(s_minishell->current_command[1][i]) != 0)
			i++;
